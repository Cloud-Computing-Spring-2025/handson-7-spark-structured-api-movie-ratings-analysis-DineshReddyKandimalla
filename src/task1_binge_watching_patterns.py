...
def main():
    ...
    input_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-DineshReddyKandimalla/input/movie_ratings_data.csv"
    output_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-DineshReddyKandimalla/Outputs/binge_watching_patterns.csv"
